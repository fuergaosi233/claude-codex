...
short idle grace period so its in-process Claude SDK is reclaimed instead of
...
4. Disconnecting the remote in Codex App closes the proxy; the adapter daemon
   idles out and the in-process Claude SDK is reclaimed automatically.
